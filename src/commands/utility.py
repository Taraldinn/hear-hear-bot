...
class UtilityCommands(commands.Cog):
    ...
    async def version(self, ctx):
        ...
        embed.add_field(
            name="Release Date", value="2025-01-01", inline=True
        )  # Update this
    ...
    async def _8ball(self, ctx, *, question):
        ...
        await ctx.send(
            format_strings[lang].format(ctx.author.mention, question, response)
        )

    @commands.command(
        aliases=["hello", "hi", "hola", "hey", "bonjour", "salut", "aloha"]
    )
    ...
    async def coinflip(self, ctx):
        ...
        coins = {"en": ["Head", "Tail"], "fr": ["Face", "Pile"]}
