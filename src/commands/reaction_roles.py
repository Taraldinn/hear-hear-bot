...
class ReactionRolesSystem(commands.Cog):
    ...
    async def schedule_self_destruct(self, message_id: int, delay: int):
        ...
        async def self_destruct():
            ...
            try:
                ...
                logger.error(f"Failed to self-destruct message {message_id}: {e}")
            finally:
    ...
    async def create_reaction_role(
        ...
        try:
            ...
            logger.error(f"Failed to create reaction role message: {e}")
            await interaction.followup.send(
    ...
    async def update_reaction_role_embed(self, message: discord.Message):
        ...
        try:
            ...
            logger.error(f"Failed to update reaction role embed: {e}")
    ...
    async def remove_reaction_role_message(self, message_id: int):
        ...
        try:
            ...
            logger.error(f"Failed to remove reaction role message {message_id}: {e}")
    ...
    async def add_role_to_member(
        ...
        try:
            ...
            logger.error(f"Failed to add role {role.name} to {member}: {e}")
    ...
    async def remove_role_from_member(
        ...
        try:
            ...
            logger.error(f"Failed to remove role {role.name} from {member}: {e}")
