...
class ConfigValidator:
    ...
    @staticmethod
    def validate_required_vars(required_vars: List[str], config_dict: Dict[str, Any]) -> List[str]:
    ...
    @staticmethod
    def validate_optional_vars(optional_vars: Dict[str, str], config_dict: Dict[str, Any]) -> List[str]:
...
class Config:
    ...
    DATABASE_TIMEOUT: int = int(os.getenv("DATABASE_TIMEOUT", "10"))  # seconds
    DATABASE_MAX_POOL_SIZE: int = int(os.getenv("DATABASE_MAX_POOL_SIZE", "100"))
    ...
    BOT_DESCRIPTION: str = "A comprehensive debate bot with timing, motions, and tournament features"
    ...
    ADMIN_ONLY_COMMANDS: List[str] = [
        "sync", "reload", "shutdown", "eval", "exec", "sql"
    ]
    RATE_LIMIT_ENABLED: bool = os.getenv("RATE_LIMIT_ENABLED", "True").lower() == "true"
    MAX_COMMANDS_PER_USER: int = int(os.getenv("MAX_COMMANDS_PER_USER", "10"))  # per minute
    ...
    ENABLE_TOURNAMENT_FEATURES: bool = os.getenv("ENABLE_TOURNAMENT_FEATURES", "True").lower() == "true"
    ...
    def validate_config(cls) -> bool:
        ...
        missing_required = ConfigValidator.validate_required_vars(required_vars, config_dict)
        ...
        missing_optional = ConfigValidator.validate_optional_vars(optional_vars, config_dict)
